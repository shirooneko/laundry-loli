        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <input readonly=""   type="text" name="biaya_tambahan" class="form-control" value="<?= buatRupiah($data['total_harga']) ?>"> 
                </div>
                <?php if ($data['total_bayar'] > 0 ): ?>
                    <div class="form-group">
                        <label>Total Bayar</label>
                        <input readonly=""   type="text" name="biaya_tambahan" class="form-control" value="<?= buatRupiah($data['total_bayar']) ?>"> 
                    </div>
                    <div class="form-group">
