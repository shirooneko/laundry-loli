...
$query = "SELECT transaksi.*,member.nama_member , detail_transaksi.total_harga FROM transaksi INNER JOIN member ON member.id_member = transaksi.member_id INNER JOIN detail_transaksi ON detail_transaksi.transaksi_id = transaksi.id_transaksi   ORDER BY transaksi.id_transaksi DESC";
              ...
              <div class="row">
                  <div class="col-lg-3 ">
                      <div class="white-box box-analis analytics-info">
                          ...
                          <ul class="list-inline two-part">
                              <li>
                                  <a href="outlet.php"><img src="../assets/images/outlite.png" width="50"></a>
                              </li>
                  ...
                  <div class="col-lg-3">
                      <div class="white-box box-analis analytics-info">
                          ...
                          <ul class="list-inline two-part">
                          <li>
                              <a href="transaksi.php"><img src="../assets/images/user.png" width="50"></a>
                          </li>
                          <li class="text-right"><i class="ti-arrow-up text-info"></i> <span class="counter text-info"><?= $juser['jumlahuser'] ?></span>
                          </li>
                          </ul>
                      </div>
                  </div>
