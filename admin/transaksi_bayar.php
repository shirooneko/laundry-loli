...
?> 
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="outlet.php"><?= $halaman ?></a></li>
                <li><a href="#">Konfirmasi Pembayaran <?= $halaman ?></a></li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="total_harga" value="<?= buatRupiah($data['total_harga']) ?>" class="form-control" readonly>
                </div>
                <div class="form-group">
