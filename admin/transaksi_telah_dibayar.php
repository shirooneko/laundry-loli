...
?> 
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Transaksi / Transaksi Telah Dibayar</a></li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <strong>Total Pembayaran <?= buatRupiah($data['total_harga']) ?></strong><br>
                        <strong>Total Uang Bayar <?= buatRupiah($data['total_bayar']) ?></strong><br>
                        <strong>Kembalian <?= buatRupiah($data['total_bayar'] - $data['total_harga']) ?></strong><br><br>
