...
--
-- Host: localhost:3306
-- Waktu pembuatan: 19 Jun 2023 pada 14.34
...
--
-- Database: `id20056048_db_laundry`
--
...
(59, 84, 14, 3, 30000, NULL, 30000),
(60, 85, 15, 6, 90000, NULL, 100000);
...
(24, 'Apriyansyah', 'bandar lampung', 'L', '08xxxxxx', '21212121'),
(25, 'Yoga fradana', 'bandar lampung', 'L', '08xxxxxx', '62712t167');
...
(40, 'Polinela Laundry', 'Jln Soekarno Hatta no 1', '08xxxxxxx');
...
(14, 'kiloan', 'Paket Ambis', 10000, 40),
(15, 'kaos', 'Paket Kupu-kupu ', 15000, 40);
...
(84, 40, 'LRL20221225065404', 24, '2022-12-25 06:05:02', '2023-01-01 12:00:00', '2022-12-27 03:47:14', 0, 0, 0, 'baru', 'dibayar', 17),
(85, 40, 'LRL202212273848', 25, '2022-12-27 03:48:48', '2023-01-03 12:00:00', '2022-12-27 03:49:03', 0, 0, 0, 'baru', 'dibayar', 47);
...
(17, 'Apri Yansyah', 'admin', '21232f297a57a5a743894a0e4a801fc3', NULL, 'admin'),
(43, 'Yoga Fradana', 'admin2', '21232f297a57a5a743894a0e4a801fc3', NULL, 'admin'),
(45, 'Tri Sandika Jaya', 'admin3', '21232f297a57a5a743894a0e4a801fc3', NULL, 'admin'),
(46, 'Owner Polinela', 'owner', '72122ce96bfec66e2396d2e25225d70a', 40, 'owner'),
(47, 'Kasir Polinela', 'kasir', 'c7911af3adbd12a035b289556d96470a', 40, 'kasir');
...
--
ALTER TABLE `outlet`
  MODIFY `id_outlet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
